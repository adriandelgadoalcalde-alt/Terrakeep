...
// 6-sep-2026. `Terrakeep.Core/Data/ItemStatsFormatter` CALCULA (numeros reales, tramos,
...
// WPF ni de LocalizationService (ver Terrakeep.Core.csproj y el comentario largo de
// ItemStatsInfo.cs).
//
