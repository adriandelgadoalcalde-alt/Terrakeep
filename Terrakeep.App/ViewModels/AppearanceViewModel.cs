...
public partial class AppearanceViewModel : ObservableObject
{
    ...
    public void LoadFrom(PlrCharacter character)
    {
        ...
        // booleano - ver Terrakeep.Core.Model.PlayerVariantSets.
        IsMale = Terrakeep.Core.Model.PlayerVariantSets.IsMale(character.Gender);
    ...
    partial void OnIsMaleChanged(bool value)
    {
        ...
        RefreshPreview();
        if (_suppressWriteback || _character == null) return;
        _character.Gender = value ? Terrakeep.Core.Model.PlayerVariantSets.MaleStarter : Terrakeep.Core.Model.PlayerVariantSets.FemaleStarter;
    }
