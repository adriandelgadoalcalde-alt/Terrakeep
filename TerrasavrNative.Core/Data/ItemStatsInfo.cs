...
//   - `TerrasavrNative.Core` (este proyecto) CALCULA: numeros reales, tramo al que pertenecen
...
//   - `TerrasavrNative.App` REDACTA: `ItemStatsTextBuilder` traduce cada enum/numero a la frase
...
// lo reutiliza el mod de tModLoader (ver TerrasavrNative.Core.csproj), asi que no puede conocer
