...
// BuffLibraryTreeBuilder.cs (nombre del proyecto en ese momento, renombrado a Terrakeep.App el
// 7-sep-2026) y construia CategoryNodeViewModel (WPF/MVVM) directamente. Ahora
