...
public sealed class ItemSetFileTests
{
    ...
    {
        var item = new GameItem { Id = 4, Count = 1, Prefix = Terrakeep.Core.Model.ItemPrefix.Vanilla(1), Favorited = true }; // Iron Broadsword, prefijo real
    ...
    public void RoundTrip_PrefijoRogueDeCalamity_SeIdentificaPorNombreInterno()
    {
        ...
        var item = new GameItem { Id = 4, Count = 1, Prefix = Terrakeep.Core.Model.ItemPrefix.CalamitySynthetic(prefixEntry.Id) };
