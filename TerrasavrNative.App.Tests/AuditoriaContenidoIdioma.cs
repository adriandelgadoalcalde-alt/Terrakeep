...
internal static partial class Program
{
    ...
    private static void AuditoriaContenidoDelJuegoEnIdioma(Window window, MainViewModel vm)
    {
        ...
        try
        {
            ...
            var servicio = new TerrasavrNative.App.Services.CharacterFileService();
            ...
            if (File.Exists(mundoReal))
            {
                ...
                foreach (var categoria in Enum.GetValues<TerrasavrNative.App.ViewModels.WorldSearchCategory>())
                {
